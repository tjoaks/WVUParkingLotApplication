        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentlyOccupiedSpots = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LotTypeID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LotTypeName = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermitStartDate = table.Column<DateTime>(nullable: false),
                    PermitEndDate = table.Column<DateTime>(nullable: false),
                    WvuEmployeeID = table.Column<string>(nullable: false),
                    ParkingEmployeeWhoAssignedPermitID = table.Column<string>(nullable: true),
                    DateTimeWhenParkingPermitWasAssigned = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
